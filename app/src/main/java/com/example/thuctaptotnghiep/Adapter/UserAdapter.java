...
import com.example.thuctaptotnghiep.Activity.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    private int flw_chat;

    private FirebaseUser firebaseUser;

    public UserAdapter(Context mContext, List<User> mUsers, int isfragment, int flw_chat) {
        this.mContext = mContext;
        this.mUsers = mUsers;
        this.isfragment = isfragment;
        this.flw_chat = flw_chat;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if(user.getId().equals(firebaseUser.getUid())||flw_chat==1){
        ...
        holder.btn_follow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(holder.btn_follow.getText().equals("follow")){
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Notifications").child(user.getId()).child(firebaseUser.getUid()+"follow").removeValue();
    ...
    private void addNotification(String userid){
        ...
        hashMap.put("text","stated following you");
        hashMap.put("postid","");
