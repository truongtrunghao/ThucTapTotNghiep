        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(str_username)||TextUtils.isEmpty(str_fullname)||
                    ...
                    Toast.makeText(RegisterActivity.this, "Password must have 6 char", Toast.LENGTH_SHORT).show();
                } else {
                ...
                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            hashMap.put("bio"," ");
                            hashMap.put("imageurl","https://firebasestorage.googleapis.com/v0/b/thuctaptotnghiep-42ecd.appspot.com/o/taikhoan.jpg?alt=media&token=4bb5ca16-dd9f-4350-9e43-facd126e3b10");
